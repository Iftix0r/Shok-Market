...
// Mahsulot qo'shish yoki o'chirish (yashirish)
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['add_product'])) {
        ...
        // Yumshoq o'chirish (o'tgan buyurtmalarni buzmaslik uchun bazadan uchmaydi, shunchaki status=0 bo'ladi)
...
<body class="bg-light">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item"><a class="nav-link" href="index.php"><i class="fas fa-shopping-cart"></i> Buyurtmalar</a></li>
    ...
    <div class="container mt-4 mb-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold m-0">Mahsulotlar katalogi</h3>
            ...
            <div class="col">
                <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="card-footer bg-light border-0 pt-0 pb-3">
                        <form method="post" onsubmit="return confirm('Mahsulotni katalogdan olib tashlaysizmi?');">
                            <input type="hidden" name="product_id" value="<?= $p['id'] ?>">
                            <button type="submit" name="delete_product" class="btn btn-outline-danger btn-sm w-100"><i class="fas fa-trash"></i> O'chirish</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form method="post" class="modal-content rounded-4 border-0 shadow">
                <div class="modal-header border-0 bg-warning rounded-top-4">
                    <h5 class="modal-title fw-bold text-dark"><i class="fas fa-box-open"></i> Yangi mahsulot</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body p-4">
                    <div class="mb-3">
                        <label class="form-label text-muted fw-bold small">MAHSULOT NOMI</label>
                        <input type="text" name="name" class="form-control form-control-lg bg-light" required placeholder="Masalan: Qizil Olma">
                    </div>
                    <div class="row mb-3">
                        <div class="col-6">
                            <label class="form-label text-muted fw-bold small">NARXI</label>
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" name="unit" class="form-control form-control-lg bg-light" value="so'm/kg" required>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label text-muted fw-bold small">RASM URL MANZILI</label>
                        <input type="url" name="image" class="form-control bg-light" placeholder="https://..." required>
                        <small class="text-muted mt-1 d-block"><i class="fas fa-info-circle"></i> Mahsulot rasmi uchun to'g'ridan to'g'ri internet manzilini yozing</small>
                    </div>
                </div>
                <div class="modal-footer border-0 p-4 pt-0">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Bekor qilish</button>
                    <button type="submit" name="add_product" class="btn btn-dark px-4 fw-bold">Saqlash</button>
                </div>
            </form>
        </div>
    </div>
